...
export const JobHistoryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="strickerappApp.jobHistory.delete.question">
        <Translate contentKey="strickerappApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
