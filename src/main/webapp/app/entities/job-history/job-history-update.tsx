  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="strickerappApp.jobHistory.home.createOrEditLabel" data-cy="JobHistoryCreateUpdateHeading">
            <Translate contentKey="strickerappApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('strickerappApp.jobHistory.startDate')}
              ...
              />
              <ValidatedField
                label={translate('strickerappApp.jobHistory.endDate')}
              ...
              />
              <ValidatedField
                label={translate('strickerappApp.jobHistory.language')}
                id="job-history-language"
                name="language"
                data-cy="language"
                type="select"
              >
                <option value="FRENCH">{translate('strickerappApp.Language.FRENCH')}</option>
                <option value="ENGLISH">{translate('strickerappApp.Language.ENGLISH')}</option>
                <option value="SPANISH">{translate('strickerappApp.Language.SPANISH')}</option>
              </ValidatedField>
              <ValidatedField
                id="job-history-job"
                name="jobId"
                data-cy="job"
                label={translate('strickerappApp.jobHistory.job')}
                type="select"
              >
                <option value="" key="0" />
                {jobs
              ...
              <ValidatedField
                ...
                name="departmentId"
                data-cy="department"
                label={translate('strickerappApp.jobHistory.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
              ...
              <ValidatedField
                ...
                name="employeeId"
                data-cy="employee"
                label={translate('strickerappApp.jobHistory.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
