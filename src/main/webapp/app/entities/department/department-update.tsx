...
export const DepartmentUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...departmentEntity,
          locationId: departmentEntity?.location?.id,
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="strickerappApp.department.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
            <Translate contentKey="strickerappApp.department.home.createOrEditLabel">Create or edit a Department</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('strickerappApp.department.departmentName')}
              ...
              <ValidatedField
                ...
                name="locationId"
                data-cy="location"
                label={translate('strickerappApp.department.location')}
                type="select"
              >
                <option value="" key="0" />
                {locations
