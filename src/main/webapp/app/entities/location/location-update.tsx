  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="strickerappApp.location.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
            <Translate contentKey="strickerappApp.location.home.createOrEditLabel">Create or edit a Location</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('strickerappApp.location.streetAddress')}
              ...
              />
              <ValidatedField
                label={translate('strickerappApp.location.postalCode')}
                id="location-postalCode"
                name="postalCode"
                data-cy="postalCode"
                type="text"
              />
              <ValidatedField label={translate('strickerappApp.location.city')} id="location-city" name="city" data-cy="city" type="text" />
              <ValidatedField
                label={translate('strickerappApp.location.stateProvince')}
              ...
              <ValidatedField
                ...
                name="countryId"
                data-cy="country"
                label={translate('strickerappApp.location.country')}
                type="select"
              >
                <option value="" key="0" />
                {countries
