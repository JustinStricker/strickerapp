  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="strickerappApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="strickerappApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('strickerappApp.employee.firstName')}
              ...
              <ValidatedField
                label={translate('strickerappApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('strickerappApp.employee.email')}
                id="employee-email"
                name="email"
                data-cy="email"
                type="text"
              />
              <ValidatedField
                label={translate('strickerappApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('strickerappApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('strickerappApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('strickerappApp.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="managerId"
                data-cy="manager"
                label={translate('strickerappApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="departmentId"
                data-cy="department"
                label={translate('strickerappApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
